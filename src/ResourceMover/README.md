...
branch: dev-RegToZonal
repo: https://github.com/yashjain4/azure-rest-api-specs/blob/$(branch)
module-name: $(prefix).$(service-name)
namespace: Microsoft.Azure.PowerShell.Cmdlets.$(service-name)
clear-output-folder: true
output-folder: .
aks: $(repo)/specification/resourcemover/resource-manager/Microsoft.Migrate/stable/2022-08-01
input-file:
